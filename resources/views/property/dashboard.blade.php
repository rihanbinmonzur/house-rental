            ...
            <div class="col-md-6">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <p class="panel-subtitle">Customize the graphs as much as you want, there are so many options and
                            features to display information using JSOFT Admin Template.</p>
                    </header>
                            ...
                            <header class="panel-heading bg-primary">
                                ...
                                <div class="widget-profile-info">
                                    <div class="profile-picture">
                                        <img src="{{ asset('assets/assets/images/!logged-user.jpg') }}">
                                    </div>
                                            ...
                                            <ul class="widget-todo-list">
                                                <li>
                                                    <div class="checkbox-custom checkbox-default">
                                                        <input type="checkbox" checked="" id="todoListItem1"
                                                            class="todo-check">
                                                        <label class="todo-label" for="todoListItem1"><span>Lorem ipsum
                                                ...
                                                <li>
                                                    <div class="checkbox-custom checkbox-default">
                                                        ...
                                                        <label class="todo-label" for="todoListItem3"><span>Lorem ipsum
                                                                dolor sit amet</span></label>
                                                    </div>
                                                    <div class="todo-actions">
                                                        <a class="todo-remove" href="#">
                                                ...
                                                <li>
                                                    <div class="checkbox-custom checkbox-default">
                                                        ...
                                                        <label class="todo-label" for="todoListItem5"><span>Lorem ipsum
                                                                dolor sit amet</span></label>
                                                    </div>
                                                    <div class="todo-actions">
                                                        <a class="todo-remove" href="#">
                                            ...
                                            <ul class="simple-user-list mb-xlg">
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{ asset('assets/assets/images/!sample-user.jpg') }}"
                    ...
                    <div class="panel-body">
                        <div class="content">
                            <ul class="simple-user-list">
                                ...
                                <li>
                                    <figure class="image rounded">
                                        <img src="{{ asset('assets/assets/images/!sample-user.jpg') }}" alt="Joe Junior"
                                            class="img-circle">
                                    </figure>
                                    <span class="title">Joe Junior</span>
                                    <span class="message truncate">Lorem ipsum dolor sit.</span>
                                        ...
                                        <div class="tm-box">
                                            ...
                                            <div class="thumbnail-gallery">
                                                <a class="img-thumbnail lightbox"
                                                    href="{{ asset('assets/assets/images/projects/project-4.jpg') }}"
                                                    data-plugin-options='{ "type":"image" }'>
                                                    <img class="img-responsive" width="215"
                                                        src="{{ asset('assets/assets/images/projects/project-4.jpg') }}">
                                                    <span class="zoom">
