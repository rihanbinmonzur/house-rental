...
<body>
            ...
            <div class="col-lg-10">
                <div class="form-container">
                    <div class="header-section">
                        <h1><i class="fas fa-edit me-2"></i>Edit Apartment Unit</h1>
                        <p>Update unit information for Unit #{{ $unit->unit_number ?? '' }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('unit.update', $unit->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="property_id" class="form-label required-field">Property ID</label>
                                    <input type="number" class="form-control" id="property_id" name="property_id" 
                                           value="{{ old('property_id', $unit->property_id) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="bedrooms" name="bedrooms">
                                        <option value="0" {{ old('bedrooms', $unit->bedrooms) == 0 ? 'selected' : '' }}>0</option>
                                        <option value="1" {{ old('bedrooms', $unit->bedrooms) == 1 ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('bedrooms', $unit->bedrooms) == 2 ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('bedrooms', $unit->bedrooms) == 3 ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('bedrooms', $unit->bedrooms) == 4 ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('bedrooms', $unit->bedrooms) == 5 ? 'selected' : '' }}>5+</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="bathrooms" class="form-label">Bathrooms</label>
                                    <select class="form-select" id="bathrooms" name="bathrooms">
                                        <option value="1" {{ old('bathrooms', $unit->bathrooms) == 1 ? 'selected' : '' }}>1</option>
                                        <option value="1.5" {{ old('bathrooms', $unit->bathrooms) == 1.5 ? 'selected' : '' }}>1.5</option>
                                        <option value="2" {{ old('bathrooms', $unit->bathrooms) == 2 ? 'selected' : '' }}>2</option>
                                        <option value="2.5" {{ old('bathrooms', $unit->bathrooms) == 2.5 ? 'selected' : '' }}>2.5</option>
                                        <option value="3" {{ old('bathrooms', $unit->bathrooms) == 3 ? 'selected' : '' }}>3</option>
                                        <option value="3.5" {{ old('bathrooms', $unit->bathrooms) == 3.5 ? 'selected' : '' }}>3.5</option>
                                        <option value="4" {{ old('bathrooms', $unit->bathrooms) == 4 ? 'selected' : '' }}>4+</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="rent_amount" name="rent_amount" 
                                           value="{{ old('rent_amount', $unit->rent_amount) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="available" value="available" 
                                           {{ old('status', $unit->status) == 'available' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="occupied" value="occupied"
                                           {{ old('status', $unit->status) == 'occupied' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="maintenance" value="maintenance"
                                           {{ old('status', $unit->status) == 'maintenance' ? 'checked' : '' }}>
                        ...
                        <div class="form-section">
                            ...
                            <div class="image-section">
                                ...
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $unit->image_url) }}" alt="Current Unit Image" class="current-image">
                                </div>
                                <div class="form-text mt-2">This is the current image. Upload a new one to replace it.</div>
                            </div>
                            @endif
                            ...
                            <div class="mb-3">
                                ...
                                <div id="imagePreview" class="text-center mt-3" style="display: none;">
                                    <img id="previewImg" src="" alt="New Unit Preview" class="preview-image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="feature_laundry" name="features[]" value="laundry"
                                                   {{ in_array('laundry', $features) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="feature_pet" name="features[]" value="pet_friendly"
                                                   {{ in_array('pet_friendly', $features) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="feature_furnished" name="features[]" value="furnished"
                                                   {{ in_array('furnished', $features) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="feature_gym" name="features[]" value="gym_access"
                                                   {{ in_array('gym_access', $features) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="feature_pool" name="features[]" value="pool_access"
                                                   {{ in_array('pool_access', $features) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="custom_features" name="custom_features" rows="2" 
                                          placeholder="Enter any additional features separated by commas">{{ old('custom_features', $unit->custom_features ?? '') }}</textarea>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <a href="{{ route('unit.index') }}" class="btn btn-outline-secondary me-md-2">Cancel</a>
                            <button type="submit" class="btn btn-primary btn-submit">Update Unit</button>
                        </div>
                    </form>
    ...
    <script>
        ...
        function updateFeatureTags() {
            ...
            // Custom features
            const customFeatures = document.getElementById('custom_features');
            if (customFeatures && customFeatures.value) {
                const features = customFeatures.value.split(',').map(f => f.trim()).filter(f => f);
        ...
        const customFeaturesTextarea = document.getElementById('custom_features');
        if (customFeaturesTextarea) {
            customFeaturesTextarea.addEventListener('input', updateFeatureTags);
        }
    </script>
</body>
</html>