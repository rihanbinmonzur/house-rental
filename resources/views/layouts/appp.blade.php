...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/assets/vendor/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.custom.css') }}" />
                ...
                <div id="userbox" class="userbox">
                    <a href="#" data-toggle="dropdown">
                        <figure class="profile-picture">
                            <img src="{{ asset('assets/assets/images/!logged-user.jpg') }}" alt="Joseph Doe"
