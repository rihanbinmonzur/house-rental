...
<html class="fixed">
	<head>
		...
		<title>housead @yield('dashboard')</title>
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="{{asset('assets/assets/images/logo.png')}}" height="35" alt="JSOFT Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('assets/assets/images/!sample-user.jpg')}}" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('assets/assets/images/!sample-user.jpg')}}" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{asset('assets/assets/images/!sample-user.jpg')}}" alt="Joe Junior" class="img-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{asset('assets/assets/images/!logged-user.jpg')}}" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
							</figure>
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="{{asset('assets/assets/images/!sample-user.jpg')}}" alt="Joseph Doe" class="img-circle">
										</figure>
