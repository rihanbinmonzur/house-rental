            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('landlord.index') }}" class="btn btn-outline-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            required placeholder="Enter full name" maxlength="100" value="{{old('name',$landlord->name)}}" >
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            required placeholder="Enter email address" value="{{old('email,landlord->email')}}">
                                        <div class="form-text">Unique email address</div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="phone" class="form-label">Phone Number</label>
                                        <input type="tel" class="form-control" id="phone" name="phone"
                                            placeholder="Enter phone number" maxlength="20" value="{{old('phone',$landlord->phone)}}">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter complete address" value="{{old('address',$landlord->address)}}"></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="suspended" {{old('status', $landlord->suspended) == 'suspended' ? 'selected' : ''}}>1 >Suspended</option>
