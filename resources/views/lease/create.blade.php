                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="leaseForm" action="{{route('lease.store')}}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="unit_id" name="unit_id" required>
                                                        ...
                                                        <option value="1">Unit 1A - 123 Main St</option>
                                                        <option value="2">Unit 2B - 123 Main St</option>
                                                        <option value="3">Unit 3C - 456 Oak Ave</option>
                                                        <option value="4">Unit 4D - 456 Oak Ave</option>
                                                        <option value="5">Unit 5E - 789 Pine Rd</option>
                                                    </select>
