            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="propertyName" placeholder="e.g., Sunset Villa" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="securityDeposit" placeholder="0.00" step="0.01" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="propertyDescription" rows="3" placeholder="Describe the property features and amenities..."></textarea>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="parking" name="property_feature[]" value="parking">
                                        <label class="form-check-label" for="parking">Parking</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gym" name="property_feature[]" value="gym" >
                                        <label class="form-check-label" for="gym">Gym</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pool" name="property_feature[]" value="swiming pool">
                                        <label class="form-check-label" for="pool">Swimming Pool</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="laundry" name="property_feature[]" value="laundry">
                                        <label class="form-check-label" for="laundry">Laundry</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pets" name="property_feature[]" value="pet friendly">
                                        <label class="form-check-label" for="pets">Pet Friendly</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="security" name="property_feature[]" value="security">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="propertyPhotos" multiple accept="image/*" name="image_url" >
                        </div>
