                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="tenant_id" class="form-select" id="tenantSelect" required>
                                    ...
                                    <option value="104" {{ $mainreq->tenan_id == 104 ? 'selected' : '' }}
                                        data-units='["5"]'>David Wilson</option>
                                    <option value="105" {{ $mainreq->tenant_id == 105 ? 'selected' : '' }}
                                        data-units='["8"]'>Lisa Thompson</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="unit_id" id="unitSelect" required disabled>
                                    <option value="" {{ $mainreq->unit_id == 106 ? 'selected' : '' }}>
                                        Select tenant first</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="issueTitle"
                                placeholder="Brief description of the issue (e.g., Leaking Faucet, Broken AC)"
                                name="title" value="{{ $mainreq->title }}" required maxlength="100">
