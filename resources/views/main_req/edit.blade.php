...
<body>
    <div class="container">
        <div class="maintenance-form-container">
            ...
            <!-- Form Body -->
            <div class="form-body">
               <form action="{{route('mainreq.update',$mainreq->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="tenant_id" class="form-select" id="tenantSelect" required>
                                    ...
                                    <option value="104" {{$maintenance_request->tenan_id ==104 ? 'selected' : ''}} data-units='["5"]'>David Wilson</option>
                                    <option value="105" {{$maintenance_request->tenant_id ==105 ? 'selected' :''}} data-units='["8"]'>Lisa Thompson</option>
                                </select>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="unitSelect" class="form-label">Unit *</label>
                                <select class="form-select" name="unit_id" id="unitSelect" required disabled>
                                    <option value="" {{$maintenance_request->unit_id ==106 ? 'selected' : ''}} >Select tenant first</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="issueTitle" placeholder="Brief description of the issue (e.g., Leaking Faucet, Broken AC)" name="title" value="{{$maintenance_request->title}}"  required maxlength="100">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-textarea" id="issueDescription" placeholder="Please provide a detailed description of the issue, including when it started, how it affects you, and any other relevant information..." value="{{$maintenance_request->description}}" required maxlength="1000"></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="priority-option priority-low" data-priority="low">
                                    ...
                                    <h6>Low Priority</h6>
                                    <p class="mb-0 small text-muted">Minor issues that don't affect daily living (e.g., dripping faucet, loose cabinet handle)</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="priority-option priority-medium" data-priority="medium">
                                    ...
                                    <p class="mb-0 small text-muted">Issues that cause inconvenience (e.g., broken appliance, minor electrical issues)</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="priority-option priority-high" data-priority="high">
                                    ...
                                    <h6>High Priority</h6>
                                    <p class="mb-0 small text-muted">Issues affecting health/safety (e.g., no hot water, broken heater in winter)</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="priority-option priority-urgent" data-priority="urgent">
                                    ...
                                    <p class="mb-0 small text-muted">Emergency situations (e.g., flooding, gas leak, no power, broken locks)</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="file-upload-area" id="fileUploadArea">
                            ...
                            <input type="file" name="image_url" id="photoUpload" multiple accept="image/*" style="display: none;">
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <p class="mb-4">Your maintenance request has been received. We'll contact you shortly to schedule the repair.</p>
                    <div class="mb-4 p-3 bg-light rounded">
                        <strong>Reference #: </strong><span id="referenceNumber">MR-2023-001</span>
                    </div>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Submit Another Request</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const units = {
                '3B': { name: 'Unit 3B', property: 'Sunset Apartments' },
                '12': { name: 'Unit 12', property: 'Garden Villas' },
                '7A': { name: 'Unit 7A', property: 'City Heights' },
                '5': { name: 'Unit 5', property: 'Sunset Apartments' },
                '8': { name: 'Unit 8', property: 'Garden Villas' }
            };
            ...
            function handleTenantChange() {
                ...
                if (tenantId) {
                    ...
                    const unitCodes = JSON.parse(tenantSelect.options[tenantSelect.selectedIndex].getAttribute('data-units'));
            ...
            function handleEmergencyContact() {
                if (emergencyContact.checked) {
                    ...
                    alert('Emergency contact enabled. Your request will be prioritized and we will contact you immediately.');
                }
            }
            ...
            function submitForm() {
                ...
                const referenceNumber = 'MR-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 1000)).padStart(3, '0');
