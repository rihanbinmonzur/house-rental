               ...
               <form action="{{route('mainreq.store')}}" method="post">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="issueTitle" placeholder="Brief description of the issue (e.g., Leaking Faucet, Broken AC)" required maxlength="100">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-textarea" id="issueDescription" placeholder="Please provide a detailed description of the issue, including when it started, how it affects you, and any other relevant information..." required maxlength="1000"></textarea>
